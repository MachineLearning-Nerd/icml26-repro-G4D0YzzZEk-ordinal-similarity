# Claim (Section 6.1 / Lemma 1) — Independent representations score ~0.5, stably across N and D, unlike CKA/SVCCA/PWCCA

---
<!-- trackio-cell
{"type": "markdown", "id": "cell_g6_i", "created_at": "2026-07-22T10:00:00+00:00", "title": "Executed reproduction (TSI/QSI, at scale)"}
-->
**VERIFIED (Lemma 1, Section 6.1), at scale.** For **independent** (unaligned) representations the expected TSI and QSI are **≈ 0.5**: across a 3×3 grid of N ∈ {80,200,400} and D ∈ {10,50,150}, **TSI mean = 0.4985 (std 0.013, range 0.05)** and QSI mean = 0.4986 — flat and centered on ½ exactly as Lemma 1 predicts. The CCA-based baselines are **not** stable on the same independent data: **SVCCA std 0.257 (range 0.79)** and **PWCCA std 0.280 (range 0.78)** drift strongly with N and D (PWCCA reaches 1.0 when D approaches N), and CKA likewise varies. TSI/QSI provide a stable, dimension-agnostic null baseline that CKA/SVCCA/PWCCA do not.

---
<!-- trackio-cell
{"type": "code", "id": "cell_g6_r", "created_at": "2026-07-22T10:00:00+00:00", "title": "Executed TSI/QSI verification", "command": ["python", "repro/src/verify_tsi_v2.py"], "exit_code": 0, "duration_s": 60.0}
-->
````bash
